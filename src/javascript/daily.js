...
// Daily exercise 2
// copy and paste this code into ‘daily.test.js’
// Create array of name which consist of first and last name
// 
// ?


// var makeEmailArr = (name) => {
//     var fullName = ["first", "last"];
//     var email = ["@evolveu.ca"];
    

//     // console.log(name + eamil);
//     return name[0][0] + name + email;
