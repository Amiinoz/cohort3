import { functions, Account, ActControler } from "./account.js";

// const accountController = new AccountController();

// idGridContainer.addEventListener('click', (event) => {
wokingCards.addEventListener("click", e => {
  console.log(event);

  /*Account Summary*/

  if (event.target.id === "idAddAcc") {
    console.log("Hello world from addaccount button");
    if (idNewAccountName.value === "") {
      // idAccountMessage.textContent = "Please enter an account name.";
      alert("Please Enter name for the account");
    } else {
